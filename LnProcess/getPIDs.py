...
def getPIDs(gv, processName, str2Search=None):
    if gv.OpSys.upper() == 'WINDOWS':
        PIDs = getPIDsWin(gv, processName, str2Search=str2Search)
        # Sarebbe da usare il comando che segue per avere anche la command line
        # wmic /output:d:\process.txt process get description,executablepath
    else:
        PIDs = getPIDsUnix(gv, processName, str2Search=str2Search)
